...
| Deploy backend to Heroku                                                     | H              | 30 mins              | 1                 | Day 4       | o            |
| Fix bugs of deploying backend to Heroku                                      | H              | 1                    | 2                 | Day 4       | o            |
| Test if Heroku works with frontend (sign up === seed data)                   | H              | 15 mins              | 1.5               | Day 4 - 4.5 | o            |
| Fix bugs of the flow of sign in, log in, log out                             | H              | 1                    | 2                 | Day 4.5     | o            |
